...
This repository contains source content for the official `AWS Toolkit for Visual Studio User Guide`_. 
...
.. _`AWS Toolkit for Visual Studio User Guide`: http://docs.aws.amazon.com/AWSToolkitVS/latest/UserGuide/welcome.html
